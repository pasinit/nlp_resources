...
class MyCallbackTrainer(TrainerBase):
    ...
    def batch_outs_and_loss(self, batch_group: List[TensorDict], for_training: bool) -> Tuple[
    ...
    def train_one_epoch(self) -> None:
        ...
        for self.batch_group in batch_groups_tqdm:
            ...
            description = "epoch: %d, dataset: %s, %s" % (self.epoch_number, "train", description)
        ...
        for self.epoch_number in range(self.epoch_number, self.num_epochs):
            ...
            if self.epoch_number < self.num_epochs - 1:
                ...
                estimated_time_remaining = training_elapsed_time * \
                                           ((self.num_epochs - starting_epoch) / float(
                                               self.epoch_number - starting_epoch + 1) - 1)
